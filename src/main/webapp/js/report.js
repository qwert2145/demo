...
///<jscompress sourcefile="zfb.m.js" />
+function(h,f){function p(a,c){1==arguments.length?console.info(a):(console.info(a+":"),console.info(c))}function q(a,c){var d=arguments;1==d.length?console.info(a):(console.info(a+":"),console.info(c));var b=f.querySelector("#zfbLog"),g=f.createElement("div");g.style.borderBottom="1px solid #ff0000";g.style.padding="5px";b||(b=f.createElement("div"),b.id="zfbLog",f.body.appendChild(b));g.innerHTML=1==d.length?m++ +". ("+typeof a+")"+JSON.stringify(a):m++ +". ("+typeof c+")"+a+":"+JSON.stringify(c);b.children.length?b.insertBefore(g,b.children[0]):b.appendChild(g)}var l=function(){var a=arguments;return new l.prototype.init(a[0],a[1],a[2])};l.prototype={constructor:l,init:function(){var a=arguments;if("string"==typeof a[0])this.form=a[0],this.config=a[1],this.rules=a[2],this.validate();else if("object"==typeof a[0]){this.routes=a[0];this.logs=a[1];var c=this;setTimeout(function(){c.route()},300)}},route:function(){var a=h.location.pathname;h.console.log=1==this.logs?h.log=p:2==this.logs?h.log=q:h.log=function(){};var c={};h.location.search.replace(/(\w+)=(\w+)/g,function(a,d,e){c[d]=decodeURI(e)});console.log("\u4f20\u9012\u8fc7\u6765\u7684\u53c2\u6570:");console.log(c);for(var d in this.routes)this.routes[d].test(a)&&zfb[d].call(null,c)},validate:function(){this.result=!0;var a=this,c=f.querySelector(this.form),d=this.config,b=this.rules,g={required:/^\S+$/,email:/^(?:\w+\.?)*\w+@(?:\w+\.)+\w+$/,idcard:/(^\d{15}$)|(^\d{17}([0-9]|X)$)/,mobile:/1\d{10}/,min15_max300:/.{15,300}/,number:/^\d+$/};if(b)for(var e in b)g[e]=b[e];var k=function(){var b,e,k;for(k in d){b=f.querySelector(a.form+" .for-"+k);e=d[k];for(var h in e)if(g[h]&&!g[h].test(c[k].value)){a.result=!1;b.innerText=e[h];break}else if("equal"==h&&c[k].value!=c[e[h][0]].value){a.result=!1;b.innerText=e[h][1];break}else a.result=!0,b.innerText=""}};k();h.onkeyup=function(){k()}}};l.prototype.init.prototype=l.prototype;var m=0;l.refresh=function(a,c,d){a=a||0;var b=arguments;h.onscroll=function(){var g=f.documentElement.scrollTop||h.pageYOffset||f.body.scrollTop,e=f.body.scrollHeight,k=f.documentElement.clientHeight;g+k+a>=e&&c(g,e,k);3==b.length&&(g>a?d(!0):d(!1))};return this};h.$zfb=h.zfb=l;$zfb.cookie=function(a,c,d){var b,g;if(1<arguments.length&&"[object Object]"!==String(c)){d=d||{};if(null===c||void 0===c)d.expires=-1;"number"===typeof d.expires&&(b=864E5*d.expires,g=d.expires=new Date,g.setTime(g.getTime()+b));c=String(c);return f.cookie=[encodeURIComponent(a),"\x3d",d.raw?c:encodeURIComponent(c),d.expires?"; expires\x3d"+d.expires.toUTCString():"",d.path?"; path\x3d"+d.path:"",d.domain?"; domain\x3d"+d.domain:"",d.secure?"; secure":""].join("")}d=c||{};g=d.raw?function(a){return a}:decodeURIComponent;return(b=(new RegExp("(?:^|; )"+encodeURIComponent(a)+"\x3d([^;]*)")).exec(f.cookie))?g(b[1]):null};var n=function(){this.encode=function(a){var c="",d,b,g,e,k,h,f=0;a=a.replace(/\r\n/g,"\n");b="";for(g=0;g<a.length;g++)e=a.charCodeAt(g),128>e?b+=String.fromCharCode(e):(127<e&&2048>e?b+=String.fromCharCode(e>>6|192):(b+=String.fromCharCode(e>>12|224),b+=String.fromCharCode(e>>6&63|128)),b+=String.fromCharCode(e&63|128));for(a=b;f<a.length;)d=a.charCodeAt(f++),b=a.charCodeAt(f++),g=a.charCodeAt(f++),e=d>>2,d=(d&3)<<4|b>>4,k=(b&15)<<2|g>>6,h=g&63,isNaN(b)?k=h=64:isNaN(g)&&(h=64),c=c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(e)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(h);return c};this.decode=function(a){var c="",d,b,g,e,h,f=0;for(a=a.replace(/[^A-Za-z0-9\+\/\=]/g,"");f<a.length;)d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".indexOf(a.charAt(f++)),b="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".indexOf(a.charAt(f++)),e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".indexOf(a.charAt(f++)),h="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".indexOf(a.charAt(f++)),d=d<<2|b>>4,b=(b&15)<<4|e>>2,g=(e&3)<<6|h,c+=String.fromCharCode(d),64!=e&&(c+=String.fromCharCode(b)),64!=h&&(c+=String.fromCharCode(g));f="";for(e=c1=c2=a=0;a<c.length;)e=c.charCodeAt(a),128>e?(f+=String.fromCharCode(e),a++):191<e&&224>e?(c2=c.charCodeAt(a+1),f+=String.fromCharCode((e&31)<<6|c2&63),a+=2):(c2=c.charCodeAt(a+1),c3=c.charCodeAt(a+2),f+=String.fromCharCode((e&15)<<12|(c2&63)<<6|c3&63),a+=3);return f}};$zfb.encode=(new n).encode;$zfb.decode=(new n).decode}(window,document);
